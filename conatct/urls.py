...
urlpatterns = [
    ...
    path('adminprofile/', views.admin_profile_view, name='admin_profile'),
    path('adminsetings/', views.admin_settings, name='admin_settings'),
    path('manageuser/', views.manage_user, name='manager_user'),
]
